...
export default {
    ...
    state: {
        ...
        data: {
            ...
            street:       Core.config('user.street') || '',
            house_number: Core.config('user.house_number') || '',
            apartment:    Core.config('user.apartment') || '',
            floor:        Core.config('user.floor') || '',
            entrance:     Core.config('user.entrance') || '',
            intercom:     Core.config('user.intercom') || '',
